...
export const IcoDrink = ({ className }) => <svg className={className} viewBox="0 0 24 24" {...s}><path d="M17 2v3c0 1.5-2 3-5 3S7 6.5 7 5V2"/><path d="M7 5c0 2.5 2.2 5 5 5s5-2.5 5-5"/><path d="M7 5l-1 13a3 3 0 003 3h6a3 3 0 003-3L17 5"/><line x1="12" y1="11" x2="12" y2="21"/></svg>
export const IcoSparkle = ({ className }) => <svg className={className} viewBox="0 0 24 24" {...s}><path d="M12 2l1.5 4.5L18 8l-4.5 1.5L12 14l-1.5-4.5L6 8l4.5-1.5L12 2z"/><circle cx="6" cy="18" r="2"/><circle cx="18" cy="18" r="2"/><line x1="10" y1="17" x2="14" y2="17"/></svg>
export const IcoDishes = ({ className }) => <svg className={className} viewBox="0 0 24 24" {...s}><circle cx="12" cy="13" r="8"/><line x1="5" y1="21" x2="19" y2="21"/><path d="M9 5l1 2-1 2"/><path d="M15 5l-1 2 1 2"/></svg>
export const IcoCandy = ({ className }) => <svg className={className} viewBox="0 0 24 24" {...s}><path d="M7 17l-2 4"/><path d="M17 7l2-4"/><path d="M7.5 4.5A4 4 0 0112 3a4 4 0 014.5 1.5A4 4 0 0121 9a4 4 0 01-1.5 4.5A4 4 0 0115 18a4 4 0 01-4.5-1.5A4 4 0 016 12a4 4 0 011.5-4.5z"/><path d="M5 10l4 4"/><path d="M19 10l-4 4"/></svg>
export const IcoPalette = ({ className }) => <svg className={className} viewBox="0 0 24 24" {...s}><circle cx="12" cy="12" r="10"/><path d="M12 2a7.5 7.5 0 00-7 10.5A7.5 7.5 0 0012 22a5 5 0 004-8 5 5 0 00-4-8v-4"/><circle cx="8" cy="9" r="1.2" fill="currentColor"/><circle cx="16" cy="8" r="1.2" fill="currentColor"/><circle cx="7" cy="16" r="1.2" fill="currentColor"/><circle cx="13" cy="18" r="1.2" fill="currentColor"/></svg>
